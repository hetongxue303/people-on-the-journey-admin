...
import {useShare} from "@views/journey/share/hooks/useShare.jsx";
...
<template>
    <el-card :style="{ borderRadius: '10px' }">
        ...
        >
            ...
            <el-table-column v-if="columns[2].status" :label="columns[2].label" prop="userinfo.nickname"/>
            <el-table-column v-if="columns[3].status" :label="columns[3].label" prop="image">
                <template #default="{row}">
                    <el-image :src="row.image" class="table-image" @click="openShowImage(row.image)"/>
                </template>
            </el-table-column>
            <el-table-column v-if="columns[4].status" :label="columns[4].label" prop="content" show-overflow-tooltip/>
    ...
    >
        <el-form ref="dialogRef" :model="form" :rules="dialogRules" label-width="50">
            <el-form-item label="昵称">
                <span class="table-input" >{{ form.userinfo?.nickname }}</span>
            </el-form-item>
            <el-form-item label="封面" prop="image">
                <el-upload
                    ...
                    name="file"
                >
                    <el-image v-if="form.image" :src="form.image" title="点击更换壁纸" class="images-box" fit="fill"/>
            ...
            <el-form-item label="内容">
                <el-input v-model="form.content" class="table-input" :rows="5" resize="none" type="textarea"/>
            </el-form-item>
        </el-form>
        <template #footer>
